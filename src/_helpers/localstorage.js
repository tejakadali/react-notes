const defaultData = {'notes':[
    ...
    {id:"9803deb0-7745-11e9-930a-c7777f1b39fb",timestamp:'2019-05-15T19:09:15.150Z',note:"React and Redux implementation with use of braowser local storage"}
...
export const loadState = () => {
    ...
    console.log("serializedState", JSON.stringify(serializedState),
